/**
 * @fileoverview Parses rate-limit strings like 100/min, validates the format and unit,
 * and converts the time window into milliseconds.
 * @author Kunal Chandra Das <kunal@subatomjs.dev>
 * @copyright Copyright (c) 2026 Subatom - (Kunal Chandra Das).
 * @license MIT
 */

import type { ParsedRateLimit } from "../types/subatom.types.js";
