...
/**
 * This module is responsible for HTTP content encoding negotiation (RFC 9110 / RFC 7231).
 * It matches the client's Accept-Encoding header preferences against the server's
 * supported compression algorithms to determine the best encoding format to use for the response.
 */
