...
/**
 * This module is responsible for transparent, on-the-fly HTTP response
 * compression and content negotiation middleware in Node.js.
 * It intercepts standard response writes, negotiates compression algorithms with the client,
 * and pipes outgoing response bodies through the appropriate compression stream.
 */
...
import type { CompressionState } from "./types/compression.types.js";
...
export function createDynamicCompressionMiddleware(engine: Compression) {
	return (
		req: IncomingMessage,
		res: ServerResponse,
