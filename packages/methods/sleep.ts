/**
 * @fileoverview This module is responsible for asynchronous execution delays and
 *  time-based flow control, providing promise-based timer utilities with scheduling and cancellation support.
 ...
 */
sleep.abortable = function abortable(
	ms: number,
	signal: AbortSignal,
): Promise<void> {
