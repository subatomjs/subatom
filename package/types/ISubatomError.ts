 ...
 */
export interface ISubatomError<TDetails = unknown> extends Error {
  status: number;
  statusCode: number;
  code: string;
...
export interface ISubatomErrorOptions<TDetails = unknown> {
...
export type ErrorRequestHandler<
  TErr extends ISubatomError = ISubatomError,
  TReq = any,
  TRes = any,
...
export class SubatomError<TDetails = unknown>
  extends Error
  implements ISubatomError<TDetails>
{
  ...
  constructor(options: ISubatomErrorOptions<TDetails> = {}) {
    const safeMessage =
