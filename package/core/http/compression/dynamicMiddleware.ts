...
import type { CompressionOptions, CompressionState } from "../../../types/http/ICompression.js";
...
export function createDynamicCompressionMiddleware(
  engine: SubatomCompression,
) {
  return (
    req: IncomingMessage,
    res: ServerResponse,
