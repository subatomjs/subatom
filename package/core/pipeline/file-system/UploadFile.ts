...
export class UploadFile implements IUploadFile {
  ...
  // Cross-realm and custom instanceof support
  public static [Symbol.hasInstance](instance: any): boolean {
    return Boolean(
      instance &&
        typeof instance === "object" &&
        (instance._isUploadFile === true ||
          (typeof instance.filename === "string" &&
  ...
  // Clean serialization output for JSON logs and error responses
  public toJSON() {
    return {
