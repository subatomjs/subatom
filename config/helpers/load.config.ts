/**
 * @fileoverview Responsible to load custom user provided config file.
...
import type { ISubatomConfig, SubatomConfig } from "../types/index.types.js";
...
async function readUserConfig(filePath: string): Promise<ISubatomConfig> {
...
export function defineConfig(config: ISubatomConfig): ISubatomConfig {
	return config;
}
