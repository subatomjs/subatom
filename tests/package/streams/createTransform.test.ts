...
import { createTransform, Transform } from "../../../package/core/http/streams/methods/stream-composition/Transform.js";
...
describe("createTransform", () => {
    ...
    it("should transform chunks using the provided transform function", async () => {
        const transformStream = createTransform<string>((chunk, encoding, callback) => {
