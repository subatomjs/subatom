...
describe("UUID Utility", () => {
	...
	describe("uuid.isValid()", () => {
		it("returns true for valid RFC 4122 v4 UUIDs", () => {
			expect(uuid.isValid("a3bb189e-8bf9-4888-9912-ace4e6543002")).toBe(true);
			expect(uuid.isValid("A3BB189E-8BF9-4888-9912-ACE4E6543002")).toBe(true);
		});
		...
		it("returns false for invalid UUIDs or non-v4 identifiers", () => {
			...
			expect(uuid.isValid("6ba7b810-9dad-11d1-80b4-00c04fd430c8")).toBe(false);
			// Malformed length
			expect(uuid.isValid("a3bb189e-8bf9-4888-9912-ace4e654300")).toBe(false);
		});
	});
});
