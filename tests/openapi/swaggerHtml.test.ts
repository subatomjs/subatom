...
describe("swaggerHtml", () => {
	describe("renderSwaggerUiHtml", () => {
		it("should render default Swagger UI HTML when no arguments are provided", () => {
			...
			expect(html).toContain("https://res.cloudinary.com/drdfur81n/image/upload/v1787205861/subatom_dark_frbair.png");
			expect(html).toContain("https://res.cloudinary.com/drdfur81n/image/upload/v1787205050/subatom_lite_tpaiuf.png");
			expect(html).toContain("https://res.cloudinary.com/drdfur81n/image/upload/v1786723815/SubAtom_short_logo_a3aa59.png");
		});
	...
	expect(html).toContain('href="https://test.com/icon&quot;xss&#39;?size=32&amp;format=png"');
	...
	expect(html).toContain('"appName":"SubAtom \\u003cSecure> & \'App\'"');
		...
		it("should safely serialize runtimeConfig escaping script breaks", () => {
			...
			const html = renderSwaggerUiHtml(undefined, undefined, undefined, maliciousTitle);
