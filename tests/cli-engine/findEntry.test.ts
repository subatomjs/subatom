...
import { EntryNotFoundError, resolveEntry } from "../../package/cli-engine/utils/findEntry.js";
...
describe("resolveEntry", () => {
    ...
    it("falls back to default entry points if configured entry does not exist", () => {
        ...
        expect(warnSpy).toHaveBeenCalledWith(
            expect.stringContaining("Configured entry not found, using detected entry"),
        );
    });
