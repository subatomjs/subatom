/**
 * @fileoverview FrameworkWatcher is responsible for watching files/directories for changes and notifying your framework when a relevant file changes.
...
import watcher, {
	...
	type Event as ParcelEvent,
} from "@parcel/watcher";
import type { WatcherOptions } from "../types/index.types.js";
...
export class FrameworkWatcher {
	...
	constructor(
		options: WatcherOptions & { ignored?: readonly string[] | undefined },
	) {
		this.watchPaths =
